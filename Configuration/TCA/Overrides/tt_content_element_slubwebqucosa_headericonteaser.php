 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['tx_slubwebqucosa_headericonteaser'] = 'tx-slubwebqucosa-content-beside-text-img-left';

$GLOBALS['TCA']['tt_content']['types']['tx_slubwebqucosa_headericonteaser'] = [
    'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '',
    'FILE:EXT:slub_web_qucosa/Configuration/FlexForms/tx_slubwebqucosa_headerteasericon_flexform.xml',
    'tx_slubwebqucosa_headericonteaser'
);
