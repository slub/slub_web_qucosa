...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:slub_web_qucosa/Resources/Private/Language/locallang_tca.xlf:tx_slubwebqucosa_headerteaser.label',
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['tx_slubwebqucosa_headerteaser'] = 'tx-slubwebqucosa-content-beside-text-img-left';

$GLOBALS['TCA']['tt_content']['types']['tx_slubwebqucosa_headerteaser'] = [
    'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '',
    'FILE:EXT:slub_web_qucosa/Configuration/FlexForms/tx_slubwebqucosa_headerteaser_flexform.xml',
    'tx_slubwebqucosa_headerteaser'
);
